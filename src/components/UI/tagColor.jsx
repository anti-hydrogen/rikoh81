export const tagColor = {
  ...
  greedy: { bgColor: "#ebd723", hover: "#0b7bbcE2" },
  ...
  openCV: { bgColor: "#a02438", hover: "#1a759f" },
  machine_learning: { bgColor: "77aa7bE2", hover: "#1a759f" },
  python: { bgColor: "#3178C6E2", hover: "#265d99E2" },
  numpy: { bgColor: "#E8265EE2", hover: "#ce0840E2" },
  java: { bgColor: "#0A7B83E2", hover: "#09686dE2" },
  golang: { bgColor: "#ff7bacE2", hover: "#f7659aE2" },
  mysql: { bgColor: "#1A91DAE2", hover: "#0b7bbcE2" },
  go: { bgColor: "#3178C6E2", hover: "#f7659aE2" },
